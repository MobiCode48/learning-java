...
public abstract class ReflectionProxy {
     ...
     * 
     * @param args An array of parameters matching the constructor from the target
     *             class
     */
    ...
    /**
     * The default constructor, for when you have already an instance of the target
     * class
     * 
     ...
     * @return True if the property is found and has the specified type, false
     *         otherwise
     */
    ...
    /**
     * Checks if an existing Collection type has the parameterized type (Generics)
     * as expected (eg. List<String>)
     * 
     * @param name              The name of the property
     * @param type              The type of the property (eg. List)
     * @param parameterizedType The parameterized property (eg. String)
     * @return True if the parameterized type matches the desired type, false
     *         otherwise
     */
    ...
    /**
     * Checks if a method from the target class returns a correct parameterized
     * collection (Generics)
     * 
     ...
     * @return True if the method returns the correct parameterized collection,
     *         false otherwise
     */
